<template>
  <Modal
    :show="modalStore.modalDeleteReason"
    @hidden="modalStore.setModalDeleteReason(false)"
    ...
    <form @submit.prevent="onSubmitForm">
      <ModalBody class="grid grid-cols-12 gap-4 gap-y-3">
        <div class="col-span-12">
          ...
          <input
            id="password"
            v-model.trim="validate.passwordText.$model"
            type="password"
            class="form-control"
          ...
          <template v-if="validate.passwordText.$error">
            <div
              v-for="(error, index) in validate.passwordText.$errors"
              :key="index"
        ...
        <div class="col-span-12">
          ...
          <input
            id="reason"
            v-model.trim="validate.reason.$model"
            type="text"
            class="form-control"
